...
a1.innerHTML = "<a class='film' href=' fvod/1.Captain.Tsubasa.Road.to.(2002).dubbingv.html '><button><h2 class='gfil'>eps.01<h2></button></a>";
scrollmenu.appendChild(a1);

let a2 = document.createElement('span');
a2.innerHTML = "<a class='film' href=' fvod/2.Captain.Tsubasa.Road.to.(2002).dubbingv.html '><button><h2 class='gfil'>eps.02<h2></button></a>";
scrollmenu.appendChild(a2);

let a3 = document.createElement('span');
a3.innerHTML = "<a class='film' href=' fvod/3.Captain.Tsubasa.Road.to.(2002).dubbingv.html '><button><h2 class='gfil'>eps.03<h2></button></a>";
scrollmenu.appendChild(a3);

let a4 = document.createElement('span');
a4.innerHTML = "<a class='film' href=' fvod/4.Captain.Tsubasa.Road.to.(2002).dubbingv.html '><button><h2 class='gfil'>eps.04<h2></button></a>";
scrollmenu.appendChild(a4);

let a5 = document.createElement('span');
a5.innerHTML = "<a class='film' href=' fvod/5.Captain.Tsubasa.Road.to.(2002).dubbingv.html '><button><h2 class='gfil'>eps.05<h2></button></a>";
